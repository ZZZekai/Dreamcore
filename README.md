...
!\[Project Overview](./.readme\_assets/title.jpg)
...
📄 \*\*\[Read the Full Technical Report (PDF) Here](./.readme\_assets/Project\_Report.pdf)\*\*
...
!\[Post-processing Progression](./.readme\_assets/postprocess\_progression.png)
...
A custom HLSL shader (`DreamNoiseHX\_Lit`) that manipulates mesh geometry at the vertex level, making environments feel as if they are melting or sinking.
...
!\[Displacement Progression](./.readme\_assets/Procedral\_Falloff.png)
...
!\[Bloom Comparison](./.readme\_assets/bloom\_comparison.jpg)
